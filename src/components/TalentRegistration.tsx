    ...
    <div className="min-h-screen w-full relative flex items-center justify-center p-4 bg-black">
      ...
      <Card className="relative z-10 w-full max-w-md border-0 shadow-2xl bg-white/95 text-slate-900 animate-in fade-in zoom-in-95 duration-500">
        ...
        <CardContent className="px-6 py-4">
          <form onSubmit={handleSubmit} className="space-y-3">
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1">
                ...
                <Input id="firstName" placeholder="Lebron" required className="bg-white" />
              </div>
              <div className="space-y-1">
                <Label htmlFor="lastName">Last name</Label>
                <Input id="lastName" placeholder="James" required className="bg-white" />
              </div>
            </div>
          ...
          <Button variant="outline" className="w-full bg-white hover:bg-slate-50 border-slate-300" type="button">
